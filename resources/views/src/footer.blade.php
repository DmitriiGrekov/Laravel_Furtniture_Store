            ...
            <div class="contacts-block">
                ...
                <div class="main-soc-block">
                    <a href="" class="soc-item">
                        <img src="{{asset('storage/img/icons/soc01.png')}}" alt="">
                    </a>
                    <a href="" class="soc-item">
                        <img src="{{asset('storage/img/icons/soc02.png')}}" alt="">
                    </a>
                    <a href="" class="soc-item">
                        <img src="{{asset('storage/img/icons/soc03.png')}}" alt="">
                    </a>
                    <a href="" class="soc-item">
                        <img src="{{asset('storage/img/icons/soc04.png')}}" alt="">
                    </a>
                </div>
